...
const STEPS = [
  { num: '1', icon: 'search-outline',          title: 'Search',   desc: 'Find verified workers near you across 20+ categories' },
    ...
    <SafeAreaView style={s.safe}>
      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <View style={s.section}>
          ...
          <Text style={s.sectionTitle}>20+ categories, 150+ skills</Text>
