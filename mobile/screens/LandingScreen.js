...
const STEPS = [
  { num: '1', icon: 'search-outline',          title: 'Search',   desc: 'Find verified workers near you across 40+ categories worldwide' },
    ...
    <SafeAreaView style={s.safe}>
      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <View style={s.section}>
          ...
          <Text style={s.sectionTitle}>40+ categories, 250+ skills — worldwide</Text>
