...
#### D03 — `WiamEpisio-Trailer-Player.html`
...
#### D05 — `WiamEpisio-Player-Fullscreen.html`
- **See:** Immersive player, minimal chrome, pinch/zoom hint  
- **Tools:** Exit fullscreen, scrub

#### D06 — `WiamEpisio-Player-Buffering.html` / `WiamEpisio-Player-Error.html`
...
#### D08 — `WiamEpisio-Unlock-Success.html`
...
#### D10 — `WiamEpisio-Rate-Series.html`
- **See:** Star rating sheet  
- **Tools:** Stars, submit

#### D11 — `WiamEpisio-Share-Sheet.html`
...
#### D13 — `WiamEpisio-Creator-Public-Profile.html`
...
#### E02 — `WiamEpisio-Checkout-Web.html` / Paystack chrome
- **See:** External checkout feel (or in-app WebView chrome mock)

#### E03 — `WiamEpisio-Coins-Success.html` / `WiamEpisio-Coins-Failed.html`
- **See:** Success balance update / fail retry

#### E04 — `WiamEpisio-Transaction-History.html`
- **See:** List purchases, unlocks, bonuses  
- **Tools:** Filter

#### E05 — `WiamEpisio-Daily-Rewards.html`
- **See:** Check-in calendar, claim coin  
- **Tools:** Claim

#### E06 — `WiamEpisio-VIP-Checkout.html`
- **See:** Plan select Weekly/Monthly, price, restore purchase  
- **Tools:** Pay, restore

#### E07 — `WiamEpisio-Currency-Note.html` (small)
...
#### G01 — `WiamEpisio-Creator-Apply-Intro.html`
...
#### H04 — `WiamStudio-Series-Cover.html`
...
#### H07 — `WiamStudio-Series-Dashboard.html`
- **See:** One series hub:  
  - Cover + title  
...
#### H08 — `WiamStudio-Episode-List.html`
...
#### H09 — `WiamStudio-Episode-Upload.html`
...
#### H10 — `WiamStudio-Episode-Detail.html`
...
#### H11 — `WiamStudio-Episode-Reject-Wrong-Size.html`
...
#### H12 — `WiamStudio-Completeness-Gate.html`
