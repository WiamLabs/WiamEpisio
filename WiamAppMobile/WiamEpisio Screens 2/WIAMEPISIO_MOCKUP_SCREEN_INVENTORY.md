...
**Progress (2026-07-18):** 109 screens total delivered as HTML — **EVERY SECTION (A through L) IS 100% COMPLETE** ✅ (Section I / Founder ops excluded by request). See `WIAMEPISIO_PHASE1_CLEARING_BLOCKERS.md` for the full breakdown — this is the complete, final mockup handoff pack.  
...
#### B03 — `WiamEpisio-Forgot-Password.html` (HAVE)
- **See:** Email field, Send reset  
- **Tools:** Submit, back

#### B04 — `WiamEpisio-Reset-Password.html` (HAVE)
- **See:** New password ×2, Save  
- **Tools:** Submit

#### B05 — `WiamEpisio-OTP-Verify.html` (HAVE) (if phone OTP later)
- **See:** 6-digit code, resend timer  
- **Tools:** Code boxes, Resend, Verify

#### B06 — `WiamEpisio-Age-Gate.html` (HAVE)
...
#### C15 — `WiamEpisio-Reminders.html` (HAVE)
...
#### C20 — `WiamEpisio-Help-Center.html` (HAVE)
- **See:** FAQ categories, contact support@wiamapp.com  
- **Tools:** Expand FAQ, email / form

#### C21 — `WiamEpisio-About.html` (HAVE)
- **See:** Brand story, WiamLabs line, version

#### C22 — `WiamEpisio-Legal-Privacy.html` / `WiamEpisio-Legal-Terms.html` (HAVE — combined tabbed doc: WiamEpisio-Legal-Privacy-Terms.html)
...
#### F01 — `WiamEpisio-Novel-Hub.html` (HAVE)
...
#### F02 — `WiamEpisio-Novel-Book-Detail.html` (HAVE)
- **See:** Cover, synopsis, chapters list, Read  
- **Tools:** Add library, start read

#### F03 — `WiamEpisio-Novel-Reader.html` (HAVE)
...
#### G07 — `WiamEpisio-Creator-Apply-Accepted.html` (HAVE)
- **See:** Congrats → Open WiamStudio  
- **Tools:** Enter Studio

#### G08 — `WiamEpisio-Creator-Apply-Rejected.html` (HAVE)
...
#### H13 — `WiamStudio-Soft-Interest.html` (HAVE)
...
#### H14 — `WiamStudio-Teaser-Public-Preview.html` (HAVE)
...
#### J01 — `WiamEpisio-Offline.html` (HAVE)
- **See:** No network  
- **Tools:** Retry

#### J02 — `WiamEpisio-Force-Update.html` (HAVE)
- **See:** Must update app  
- **Tools:** Store link

#### J03 — `WiamEpisio-Maintenance.html` (HAVE)
- **See:** Down for maintenance

#### J04 — `WiamEpisio-Report-Content.html` (HAVE)
- **See:** Report reasons (spam, copyright, sexual, violence)  
- **Tools:** Submit

#### J05 — `WiamEpisio-Block-Creator.html` (HAVE)
- **See:** Confirm block  
- **Tools:** Confirm

#### J06 — `WiamEpisio-Account-Delete.html` (HAVE)
- **See:** Warning, confirm delete  
- **Tools:** Delete / Cancel

#### J07 — `WiamEpisio-Device-Limit.html` (HAVE)
- **See:** Too many devices / login blocked message

#### J08 — `WiamEpisio-Empty-Catalog.html` (HAVE)
...
## L. Extras beyond original inventory (proactively identified, not originally scoped) (6)

These were flagged as commonly-needed production states while building out the full pack — not in your original spec, built at your request afterward.

#### L01 — `WiamEpisio-Splash-Returning.html` (HAVE)
Cold-launch state for a returning user (vs. first-timer Splash) — shows "Welcome back, [name]" and resumes into their last-watched series instead of Onboarding.

#### L02 — `WiamEpisio-Push-Permission-Prompt.html` (HAVE)
In-app priming screen shown before the native OS notification prompt, with the perks listed (new episodes, reminders, coin bonuses) plus a mock of the native iOS dialog for reference.

#### L03 — `WiamEpisio-Episode-Autoplay-Countdown.html` (HAVE)
The "Up Next" overlay with a circular countdown ring between episodes, Play Now / Cancel — distinct from Next-Suggestion (D09), which is the post-series recommendation screen.

#### L04 — `WiamEpisio-Creator-Viewer-Switch.html` (HAVE)
Light transition/confirmation moment when a creator switches from the viewer app into WiamStudio on the same account.

#### L05 — `WiamEpisio-Payment-Method-Picker.html` (HAVE)
Standalone "choose a payment method" step (Mobile Money / Card / Bank / saved cards) — Checkout-Web currently bundles this inline; useful once saved-card support exists.

#### L06 — `WiamEpisio-Search-Filters-Sort.html` (HAVE)
Dedicated filter/sort bottom sheet for Search results (genre, free-only, sort by relevance/popularity/newest) — separate from the simpler filter chips already on Category-Shelf.

---

*Document version: 2026-07-17 — Mockup inventory for WiamEpisio E2E design sprint. Section L appended 2026-07-18.*
