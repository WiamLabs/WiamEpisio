/**
 * BookCard — Reusable book cover card used across Home, Browse, Library, etc.
 *
 * Props:
 *   book        — { id, title, author, cover_url, genre, rating, chapter_count }
 *   onPress     — Called with book object
 *   size        — 'default' | 'small' | 'wide'
 *   showProgress — Show reading progress bar (for Library)
