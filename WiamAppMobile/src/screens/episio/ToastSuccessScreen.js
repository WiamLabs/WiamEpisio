/**
 * Toast success demo — brief message + OK
 */
...
const ToastSuccessScreen = () => {
  ...
  const message = route.params?.message || 'Saved successfully';
...
const styles = StyleSheet.create({
  ...
  ok: { marginTop: 8, paddingHorizontal: 24, paddingVertical: 10, backgroundColor: COLORS.gold, borderRadius: RADIUS.sm },
  okText: { fontFamily: FONTS.bold, color: COLORS.navy, fontSize: 13 },
});
