...
const BookDetailScreen = ({ route, navigation }) => {
  ...
  // Push 10 — series progression context
  ...
  // Push 10 — fetch series context (silent if no series)
  useEffect(() => {
    if (!bookId) return;
    let cancelled = false;
    ...
    >
      ...
      {seriesContext?.series ? (
        ...
        >
          ...
          <Text style={styles.seriesBannerCta}>View →</Text>
        </TouchableOpacity>
      ) : null}
        ...
        <View style={styles.modalBg}>
          <View style={[styles.modalCard, { marginTop: insets.top + 60 }]}>
            <View style={styles.modalHead}>
              ...
              <TouchableOpacity onPress={() => setShowListPicker(false)}><Text style={styles.closeX}>×</Text></TouchableOpacity>
            </View>
