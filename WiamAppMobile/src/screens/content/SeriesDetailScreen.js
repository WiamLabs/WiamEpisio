/**
 * SeriesDetailScreen — public reader page (Push 10).
 *
        ...
        <View style={styles.body}>
          ...
          {firstBook ? (
            ...
            >
              ...
              <Text style={styles.startBtnText}>Start with “{firstBook.title}”</Text>
            </TouchableOpacity>
          ) : null}
          ...
          {books.length === 0 ? (
            <View style={styles.empty}>
              ...
              <Text style={styles.emptyText}>No books published yet — check back soon.</Text>
            </View>
          ) : (
            books.map((b, idx) => (
              <TouchableOpacity
