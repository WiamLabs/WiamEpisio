...
const NewStoryScreen = ({ navigation }) => {
  ...
  const pickCover = async () => {
    ...
    // We deliberately do NOT pass `allowsEditing: true` — the OS crop UI gives a
    // tiny crop box that ruins covers. We accept the original file as-is and let
    // the server normalize to 600×900 (2:3) using cover_scanner.normalize_cover.
        ...
        <ScrollView style={styles.container} contentContainerStyle={styles.content} keyboardShouldPersistTaps="handled">
          ...
          <View style={styles.coverRow}>
            ...
            <View style={styles.coverTips}>
              ...
              <Text style={styles.tipText}>Recommended size: 600 × 900 px (2:3 portrait).</Text>
              <Text style={styles.tipText}>Minimum: 400 × 600 px. Maximum file size: 5 MB.</Text>
              <Text style={styles.tipText}>Format: JPG, PNG, or WebP.</Text>
              <Text style={styles.tipText}>We will fit your image to 2:3 automatically — design your art tall, not wide. Free tools: Canva, Photoshop, BookBrush.</Text>
            </View>
          </View>
          ...
          <Text style={styles.hint}>
            After creating, you'll be taken to the Story Manager where you can write chapters, upload or change your cover, and publish chapter by chapter — just like Wattpad.
          </Text>
