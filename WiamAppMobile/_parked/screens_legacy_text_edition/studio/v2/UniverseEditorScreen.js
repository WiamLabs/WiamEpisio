 ...
 */
/**
 * UniverseEditorScreen ΓÇö minimal create/edit/delete (Push 9).
...
const UniverseEditorScreen = ({ navigation, route }) => {
  ...
  const handleDelete = () => {
    Alert.alert(
      'Delete universe',
      'This will not delete the series inside ΓÇö they will become unattached.',
      [
      ...
      <ScrollView contentContainerStyle={styles.scroll}>
        ...
        <Field label="Description">
          <TextInput
            ...
            placeholder="A few sentences describing this universeΓÇª"
            placeholderTextColor={COLORS.textMuted}
            value={description}
