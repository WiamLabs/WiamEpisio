    ...
    <AppBackground>
      ...
      <View style={styles.summary}>
        ...
        <Text style={styles.summaryText}>
          {hasOfflineAccess
            ? `${rows.length} chapters cached ΓÇó ${formatBytes(sizeBytes)} ΓÇó ${Math.min(uniqueBookCount, offlineLimit)}/${offlineLimit} books`
          ...
          >
            <View style={{ flex: 1 }}>
              ...
              <Text style={styles.itemSub} numberOfLines={1}>
                {item.book_title || `Book ${item.book_id}`} ΓÇó Chapter {item.chapter_number}
              </Text>
            </View>
