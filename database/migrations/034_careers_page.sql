-- ============================================================
-- WIAMAPP MIGRATION 034 — Public Careers Page Tables
-- © 2026 WiamApp. Powered by WiamLabs
--
-- Restores career_positions and career_applications from the old
-- migrations/016_team_members.sql — never carried into the live
-- V4 database, same story as every other restore this session.
-- Deliberately does NOT restore team_members from that same file
-- — that table is internal staff login/auth and belongs with
-- app.wiamlabs.com's build, a separate concern from the public
-- careers page this migration actually serves.
--
-- cv_s3_key is renamed to cv_upload_url here, since your project
-- has since moved from AWS S3 to Cloudflare R2 — same column,
-- corrected name to match what's actually used everywhere else.
-- ============================================================
...
-- ============================================================
-- RLS — career_positions is public-readable, career_applications
-- can be inserted by anyone (no login required to apply) but only
-- read by admin staff through the service role.
-- ============================================================
